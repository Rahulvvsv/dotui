 ...
 * viewport (full width + at least full height) and stacks the top bar over a body row
 * (the sidebar beside the main content). Sub-panels are passed in as slots so each keeps
 * its own schema scope while living inside this one base panel.
 */
