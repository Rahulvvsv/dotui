 ...
 * ships in lockstep with the components it describes. This is the single import site for
 * the app (page snapshots it into the DB; shell passes it to the devtools).
 *
 * Regenerate with `corepack pnpm --filter @dotui/demo run schema`. It is also
